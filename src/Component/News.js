...
export default class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=da07ee5053bb4cc2b6f61dba3daa5ea1&page=${this.state.page}&pageSize=${this.props.pageSize}`;
